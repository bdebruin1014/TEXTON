      ...
      <div key={folder.id}>
        <button
          ...
          className={cn(
            ...
            isSelected ? "bg-primary/10 text-primary font-medium" : "text-foreground hover:bg-accent/50",
      ...
      <div className="w-[360px] rounded-lg border border-border bg-white shadow-xl">
        ...
        <div className="max-h-[300px] overflow-y-auto p-2">
          ...
          <button
            ...
            className={cn(
              "flex w-full items-center gap-2 rounded px-2 py-1.5 text-sm transition-colors",
              selectedId === null ? "bg-primary/10 text-primary font-medium" : "text-foreground hover:bg-accent/50",
            )}
          >
