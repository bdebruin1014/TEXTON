...
export const Route = createFileRoute("/_authenticated/projects/$projectId/due-diligence")({
...
function DueDiligence() {
  ...
  const { data: items = [], isLoading } = useQuery<DDItem[]>({
    queryKey: ["project-dd-items", projectId],
    queryFn: async () => {
  ...
  const addItem = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["project-dd-items", projectId] }),
  });
